 ...
 * Copyright notice
 *
 * (c) 2010 Andreas Cord-Landwehr, FSMI Uni Paderborn
 * All rights reserved
 *
...
class tx_fsmiprotocols_realurl {
...
// 		return $config;
	...
	function addPostVarSets() {
		...
		$postVarSets['protocols'] = array(
			$this->addSimple('fsmi_protocols[year]'),
			$this->addTable('fsmi_protocols[showUid]', 'tx_fsmiprotocols_list', 'meeting_date')
		);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fsmi_protocols/hooks/class.tx_fsmiprotocols_realurl.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cal/hooks/class.tx_fsmiprotocols_realurl.php']);
}
?>
