...
// 		return $config;
	...
	function addPostVarSets() {
		...
		$postVarSets['protocols'] = array(
			$this->addSimple('meetings[year]'),
			$this->addTable('meetings[showUid]', 'tx_meetings_list', 'meeting_date')
		);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/meetings/hooks/class.tx_meetings_realurl.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cal/hooks/class.tx_meetings_realurl.php']);
}
?>
