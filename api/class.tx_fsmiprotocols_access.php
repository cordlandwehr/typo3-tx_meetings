...
class tx_fsmiprotocols_access {
	...
	private function evaluateUsersAccessLevels() {
		...
		$res =$GLOBALS['TYPO3_DB']->sql_query('SELECT *
											FROM tx_fsmiprotocols_access_admission
											WHERE
	...
	private function initAccessLevels() {
		$committeeDATA = t3lib_BEfunc::getRecord('tx_fsmiprotocols_committee_list', $this->committeeUID);
...
// Include extension?
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fsmi_protocols/api/class.tx_fsmiprotocols_access.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fsmi_protocols/api/class.tx_fsmiprotocols_access.php']);
}
?>