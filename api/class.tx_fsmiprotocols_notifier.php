 ...
 *
 */
class tx_fsmiprotocols_notifier {
...
// Include extension?
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fsmi_protocols/api/class.tx_fsmiprotocols_notifier.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fsmi_protocols/api/class.tx_fsmiprotocols_notifier.php']);
}
?>